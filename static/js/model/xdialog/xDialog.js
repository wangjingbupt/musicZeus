        ...
        plugin.create = function(){
            ...
            if(this.settings.type && this.settings.type == 'tips'){
                ...
                if(this.settings.ok && typeof this.settings.ok == 'function'){
                    $('<div>',{'class':'popup-footer clear'}).html('<div><a class=\"btn btn-danger x-ok\" href=\"javascript:;\">确定<\/a>&nbsp;&nbsp;<a href=\"javascript:;\" class=\"btn x-cancel\">取消<\/a></div>').appendTo(this.dialog);
                }
            }
